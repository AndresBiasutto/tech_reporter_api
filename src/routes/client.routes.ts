...
import { assignClientRole, createClient, deleteClient, updateClient } from '../controllers/company-account.controller';
...
import { validateCreateClient, validateRoleAssignment, validateUpdateClient } from '../validators/company-account.validators';
...
clientRouter.patch('/:id', authenticate, validateBody(validateUpdateClient), validateUuidParam('id'), requireAccountType('company', 'client'), asyncHandler(updateClient));
